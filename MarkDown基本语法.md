<a id="user-content-user-content-home"></a>  ***Markdown语法简要目录***
___
...
<a id="user-content-5"></a>5、有序列表 [返回目录](#user-content-home)
===
* 使用数字和点组合(1.)表示有序列表。
* 格式：数字序号.[空格]
-
...
<a id="user-content-6"></a>6、文字引用 [返回目录](#user-content-home)
===
* 使用 > 表示文字引用。
* 格式：>\[空格](也可以不用空格)文字内容
-
...
<a id="user-content-7"></a>7、部分文字高亮 [返回目录](#user-content-home)
===
* 使用 \`代码` 表示行内代码块。
-
**示例**<br/>
...
<a id="user-content-8"></a>8、代码块 [返回目录](#user-content-home)
===
* 使用 四个缩进空格 表示代码块。
* 格式：tab或4个空格
-
...
<a id="user-content-9"></a>9、插入图像 [返回目录](#user-content-home)
===
...
<a id="user-content-10"></a>10、引入代码块 [返回目录](#user-content-home)
===
* 将代码块包含在 \`\`\` ... ``` 内
-
**示例**
